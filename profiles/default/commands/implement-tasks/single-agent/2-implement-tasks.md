Now that you have the task group(s) to be implemented, proceed with
implementation by following these instructions:
...
IF all tasks are now marked as done (with `- [x]`) in tasks.md, display this
message to user:
...
IF there are still tasks in tasks.md that have yet to be implemented (marked
