...
2: Delegate implementation to the implementer subagent PHASE 3: After ALL task
groups have been implemented, delegate to implementation-verifier to produce the
...
Delegate to the **implementer** subagent to implement the specified task
group(s):
