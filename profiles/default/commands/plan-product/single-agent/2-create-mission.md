Now that you've gathered information about this product, use that info to create
the mission document in `agent-os/product/mission.md` by following these
instructions:
...
IMPORTANT: Ensure the product mission is ALIGNED and DOES NOT CONFLICT with the
